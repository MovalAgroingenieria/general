...
class ScrapAnnualReportWizard(models.TransientModel):
    ...
    def print_report(self):
        ...
        if not report_data:
            raise UserError(_("No SCRAP contributions found for year %s.") % self.year)
    ...
    def _get_report_data(self):
        ...
        for invoice in invoices:
            ...
            for line in invoice.invoice_line_ids:
                ...
                for component in components:
                    ...
                    weight_kg = (component.weight_grams / 1000.0) * line.quantity * sign
        ...
        for material_name in sorted(grouped_data.keys()):
            ...
            for submaterial_name in sorted(submaterials.keys()):
                ...
                submaterial_data["types"].sort(key=lambda x: x["submaterial_type_name"])
