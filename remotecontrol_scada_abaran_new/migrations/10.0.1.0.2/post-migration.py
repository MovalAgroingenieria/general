...
def migrate(cr, version):
    ...
    try:
        procedure = env.ref('remotecontrol_scada_abaran_new.remotecontrol_'
                            'scada_abaran_new_procedure_daily_sync')
        procedure.write({'procedure_for_readings': True})
    except Exception:
        pass
    # Patch action: remotecontrol_scada_abaran_new_action_get_devices
    try:
        action = env.ref('remotecontrol_scada_abaran_new.remotecontrol_scada_'
                         'abaran_new_action_get_devices')
        action.write({
            'code': '''
