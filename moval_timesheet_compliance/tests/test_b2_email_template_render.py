...
class TestComplianceDailyB2(TimesheetComplianceCase):
    ...
    def test_b2_template_renders_and_contains_link(self):
        ...
        self.assertIn("View your timesheet lines for this day", rendered)
        self.assertIn('href="', rendered)
        self.assertIn("/web", rendered)
        self.assertIn("/web#action=", rendered)
        self.assertIn("compliance_form_url", template.body_html)
        self.assertIn("Open this day", rendered)
        self.assertIn("compliance record", rendered)
