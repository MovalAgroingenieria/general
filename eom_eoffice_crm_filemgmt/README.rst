...
=================================
Electronic Office File Management
=================================

Module to link the input and output record (crm_lettermgmt) and electronic files
(crm_filemgmt) with the electronic office electronic files and communications.
