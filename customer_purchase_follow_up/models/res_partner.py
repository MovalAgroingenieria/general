...
class ResPartner(models.Model):
    ...
    last_notification_date = fields.Datetime(
        string="Last Notification Date", help="Date when the last notification was sent"
    )
    ...
    def _create_crm_opportunity(self):
        ...
        opportunity_vals = {
            ...
            % (self.days_since_last_purchase, self.last_purchase_date or _("Never")),
    ...
    def reset_notification_status(self):
        ...
        return {
            ...
            "target": "current",
            "context": {
                "notification_message": _("Notification status reset " "successfully."),
            },
        }
