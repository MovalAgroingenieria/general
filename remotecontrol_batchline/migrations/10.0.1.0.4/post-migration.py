...
def migrate(cr, version):
    ...
    try:
        procedure = env.ref(
            'remotecontrol_batchline.remotecontrol_batchline_procedure')
        procedure.write({'procedure_for_readings': True})
    except Exception:
        pass

    # Patch action: remotecontrol_batchline_action_get_devices
    try:
        action = env.ref(
            'remotecontrol_batchline.'
            'remotecontrol_batchline_action_get_devices')
        action.write({
            'code': '''
...
''',
    ...
    # Patch action: remotecontrol_batchline_action_get_pressure_devices
    try:
        action = env.ref('remotecontrol_batchline.remotecontrol_'
                         'batchline_action_get_pressure_devices')
        action.write({
            'code': '''
