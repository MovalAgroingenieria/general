...
def migrate(cr, version):
    ...
    try:
        procedure = env.ref('remotecontrol_alsambo.remotecontrol_alsambo_procedure_daily_sync')
        procedure.write({'procedure_for_readings': True})
    except Exception:
        pass


    # Patch action: remotecontrol_alsambo_action_get_devices
    try:
        action = env.ref('remotecontrol_alsambo.remotecontrol_alsambo_action_get_devices')
        action.write({
            'code': '''
