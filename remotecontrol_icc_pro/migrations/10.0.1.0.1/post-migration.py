...
def migrate(cr, version):
    ...
    try:
        procedure = env.ref('remotecontrol_icc_pro.remotecontrol_'
                            'icc_pro_procedure_daily_sync')
        procedure.write({'procedure_for_readings': True})
    except Exception:
        pass
    # Patch action: remotecontrol_icc_pro_action_build_sensor_plan
    try:
        action = env.ref('remotecontrol_icc_pro.remotecontrol_icc_pro_'
