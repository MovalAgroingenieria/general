...
class TrialBalanceReportWizard(models.TransientModel):
    ...
    def get_item_ids(self, account, start_date, end_date):
        ...
        if group_by_field:
            ...
            values_in_move_lines = {line[group_by_field]: line for line in move_lines}
            ...
            for line in move_lines_back:
                ...
                if (
                    values_in_move_lines
                    and group_value not in values_in_move_lines
                    or not values_in_move_lines
                ):
            ...
            item_lines = []
            initial_balance = self.get_initial_balance(account, None, start_date)
    ...
    def get_initial_balance(self, account, group_value, start_date):
        ...
        if account.code[:3] == "129":
            ...
            #     fields=['debit', 'credit']
            # )
            initial_balance = sum(line["debit"] - line["credit"] for line in amlines)
