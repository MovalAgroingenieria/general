...
def migrate(cr, version):
    ...
    #    - Sensors sharing the same device/parameter are fetched in one call
    #    - Long date windows are split into 30-day chunks
...
"""
    ...
    # ── 2) Update remotecontrol_help (1.0.9 docs + fixed HTML note) ───
    new_help = u"""
<h2>4eGrowth · Odoo Integration Help</h2>
...
<p>Type: <code>REST</code> · Base URL: <code>https://panel.4egrowth.com</code></p>
