...
"""HTTP tests: Public display GET /assembly/display and /assembly/display/data (auth=public)."""
...
class TestHttpPublicDisplay(AssemblyHttpCase):
    ...
    def test_dsp_01_display_page_valid_assembly_200(self):
        ...
        self._skip_if_route_404(res, "Public display page")
    ...
    def test_dsp_02_display_data_json_200_no_personal_data(self):
        """DSP-02: GET /assembly/display/data?assembly_id=<id> returns JSON without names/NIF/email."""
        res = self._public_request(
            "/assembly/display/data?assembly_id=%s" % self.assembly.id
        )
        self._skip_if_route_404(res, "Public display data")
        self.assertEqual(res.status_code, 200)
    ...
    def test_dsp_04_display_without_assembly_id_400_or_404(self):
        ...
        res = self._public_request("/assembly/display")
