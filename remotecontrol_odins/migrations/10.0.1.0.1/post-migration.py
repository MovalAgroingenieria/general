...
def migrate(cr, version):
    ...
    # Update action: ODINS: Get devices
...
selected_device_id = bag.get('selected_device_id')
if selected_device_id:
    condition.append(('device_id', '=', selected_device_id))
...
"""
    xml_id_get_devices = 'remotecontrol_odins_action_get_device'
    try:
        action_get_devices = env.ref(
            'remotecontrol_odins.%s' % xml_id_get_devices)
